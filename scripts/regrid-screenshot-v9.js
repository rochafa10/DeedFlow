#!/usr/bin/env node
/**
 * Regrid Screenshot Capture Script v9
 *
 * FIXES in v9:
 * - Fixed map click coordinates from (200, 400) to (960, 540)
 * - (200, 400) was hitting the left sidebar, causing page close
 * - (960, 540) is the true center of 1920x1080 viewport
 *
 * FIXES in v8:
 ...
 *
 * Usage: node regrid-screenshot-v9.js <parcel_id> <county> <state> <property_id>
...
(async () => {
  ...
  try {
    ...
    // Step 9: Click in the CENTER of the map to deselect any UI elements
    // v9 FIX: Changed from (200, 400) to (960, 540) - true center of 1920x1080 viewport
    // (200, 400) was hitting the left sidebar which caused page close
    try {
      await page.mouse.click(960, 540);  // Center of 1920x1080 viewport
      await page.waitForTimeout(500);
      console.error('[Screenshot] Clicked on map center to deselect');
    } catch (e) {
