#!/usr/bin/env node
/**
 * Regrid Screenshot Capture Script v7
 *
 * FIXES in v7:
 * - Changed waitUntil from 'networkidle' to 'load' to prevent timeouts
 * - Regrid has ongoing map tile/analytics requests that block networkidle
 *
 * FIXES in v6:
 ...
 *
 * Usage: node regrid-screenshot-v7.js <parcel_id> <county> <state> <property_id>
