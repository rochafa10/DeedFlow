...
export const sampleRiskAssessment: RiskAssessment = {
  ...
  drought: {
    ...
    droughtDescription: "No drought conditions",
    percentileRanking: 55,
    historicalDrought: {
      count: 2,
      percentageInDrought: 8,
      worstCategory: "D1",
    ...
    waterRestrictions: [],
    cropImpact: "none",
    landImpactDescription: "No significant drought impact on land value",
    avgAnnualPrecipitation: 42,
