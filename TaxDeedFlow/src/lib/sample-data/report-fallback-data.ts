/**
 * Fallback Data for Property Report Page
 *
 * Contains all fallback/sample data used in the dynamic property report page.
 * This data is used when real data from APIs or the database is unavailable.
 *
 * @module lib/sample-data/report-fallback-data
...
export const sampleRiskAssessment: RiskAssessment = {
  ...
  drought: {
    ...
    dataSource: { name: "US Drought Monitor", type: "api", reliability: "high" },
    confidence: 80,
  },
  categoryScores: [
